...
const BasketAdds = () => {
  ...
  <p>{item.title} - {item.price} </p>
                ...
                <IconButton aria-label="delete"   onClick={() => dispatch(decreaseQuantity(item.title))}
                  color="inherit"
                  variant="outlined">
        <ArrowBackIosIcon/>
      </IconButton>
              ...
              <IconButton aria-label="delete"   onClick={() => dispatch(increaseQuantity(item.title))}
                  color="inherit"
                  variant="outlined">
        <ArrowForwardIosIcon />
      </IconButton>
                   ...
                   <IconButton aria-label="delete" onClick={() => dispatch(removeItem(item.title))}
                  color="inherit"
                  variant="outlined">
        <DeleteIcon /> 
      </IconButton>
