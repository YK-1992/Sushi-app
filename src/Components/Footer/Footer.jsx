        ...
        <div className="footer-container">
            <div className="contact-block">
                ...
                <div className='contact-set'>
                    ...
                    <span>Mo-So, 10:00 bis 23:00 Uhr
Annahme von Bestellungen zur Lieferung und Abholung
endet um 20:00 Uhr.</span> 
                </div>
...
<Map style={{width: '100%', height: '60vh', zIndex: '-1'}}
            defaultCenter={{lat:52.54175305285189,lng:13.238990247221375}}
            defaultZoom={14}
            
            gestureHandling={'cooperative'}
            disableDefaultUI={true}>
<Marker position={{ lat: 52.54175305285189, lng: 13.238990247221375 }} />  
</Map>
  </APIProvider>
